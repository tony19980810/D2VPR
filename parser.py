...
def parse_arguments_D2VPR():
    parser = argparse.ArgumentParser(description="Benchmarking Visual Geolocalization",
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    # Training parameters
    parser.add_argument("--teacher", type=bool, default=True)
    parser.add_argument("--train_batch_size", type=int, default=8,
                        help="Number of triplets (query, pos, negs) in a batch. Each triplet consists of 12 images")
    parser.add_argument("--patience", type=int, default=30)
    parser.add_argument("--lr", type=float, default=0.000025, help="_")
    ...
    parser.add_argument("--foundation_model_path", type=str, default='./dinov2_vits14_pretrain.pth',
                        help="Path to load foundation model checkpoint.")
    parser.add_argument("--resume", type=str, default='./CricaVPR.pth',
    ...
    parser.add_argument("--eval_datasets_folder", type=str, default='/root/lanyun-tmp/test', help="Path with all datasets")
    parser.add_argument("--eval_dataset_name", type=str, default="msls_val", help="Relative path of the dataset")
    parser.add_argument("--pca_dataset_folder", type=str, default='pitts30k/images',
