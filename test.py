...
def test_efficient_ram_usage(args, eval_ds, model, test_method="hard_resize"):
    ...
    with torch.no_grad():
        ...
        queries_dataloader = DataLoader(dataset=queries_subset_ds, num_workers=0,
        ...
        for inputs, indices in tqdm(queries_dataloader, ncols=100):
            ...
            features,_,_ = model(inputs.to(args.device))
        ...
        database_dataloader = DataLoader(dataset=database_subset_ds, num_workers=0,
